...
include 'shop-shopping-cart.php';
$cartItems = $_SESSION['cart'] ?? [];

// Função para exibir um campo de entrada pré-preenchido
function prefill($field, $userData) {
    return $userData && isset($userData[$field]) ? htmlspecialchars($userData[$field]) : '';
}
?>
