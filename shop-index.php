        ...
        <div class="row margin-bottom-40 ">
          ...
          <div class="sidebar col-md-3 col-sm-4">
            <ul class="list-group margin-bottom-25 sidebar-menu">
              <li class="list-group-item clearfix"><a href="shop-product-list.html"><i class="fa fa-angle-right"></i> Etiquetas</a></li>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 pre-footer-col">
            <h2>Sobre nós</h2>
            <p>Somos a filial da Crispel Etiquetas do Rio de Janeiro, situada na cidade de Paraíba do Sul - RJ. </p>
            <p>Atendemos todo o sul do estado do Rio de Janeiro e interior de Minas Gerais.</p>
          </div>
